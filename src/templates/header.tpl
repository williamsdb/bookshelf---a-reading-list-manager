...
<head>
	...
	<link rel="stylesheet" href="/assets/css/custom.css?v=1.26">
	...
	<div class="container">
		<header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
			<a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
				<!-- Light mode logo -->
				<img src="/assets/brand/logo-light.png" class="logo logo-light" width="300" height="62" alt="Logo">

				<!-- Dark mode logo -->
				<img src="/assets/brand/logo-dark.png" class="logo logo-dark" width="300" height="62" alt="Logo">
			</a>
